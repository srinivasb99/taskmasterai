...
// Updated Logo component with smaller SVG and "Status" text
const Logo = () => (
  <div className="flex items-center space-x-2">
    <svg
      className="w-10 h-10 text-indigo-500"  // Slightly smaller than before
      viewBox="0 0 24 24"
      fill="none"
      ...
      >
        <div className="container mx-auto px-4 py-4">
          <nav className="flex items-center justify-between">
            {/* Logo on the left with "Status" text */}
