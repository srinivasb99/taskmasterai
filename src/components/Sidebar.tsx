...
import { LayoutDashboard, Settings, FileText, CalendarDays, Users2, Globe2, ZapOff, Bot, Crown, CircleUserRound, PanelLeftClose, PanelLeftOpen, Menu, X } from 'lucide-react';
...
export function Sidebar({
  ...
  const mobileMenuButtonBg = isIlluminateEnabled
  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed top-4 left-4 z-50 p-2 rounded-lg md:hidden ${mobileMenuButtonBg} transition-all duration-300`}
      ...
      <div
        className={`
          ...
          ${isMobileMenuOpen ? 'w-64' : '-translate-x-full md:translate-x-0'}
        `}
      >
        {/* Logo Section */}
