      ...
      <AnimatePresence>
        {isAIChatOpen && (
          <motion.div
            ...
            className="fixed right-0 top-0 h-full w-96 z-50 shadow-xl"
          >
            <div className={`h-full ${containerBg} flex flex-col`}>
              ...
              >
                <div className="flex items-center gap-2">
                  <Bot className={`w-5 h-5 ${isIlluminateEnabled ? "text-blue-600" : "text-blue-400"}`} />
                  <div>
                ...
                <motion.button
                  ...
                  className={`p-1 rounded-full ${isIlluminateEnabled ? "hover:bg-gray-100" : "hover:bg-gray-700"}`}
                >
                  <X className={`w-5 h-5 ${isIlluminateEnabled ? "text-gray-600" : "text-gray-400"}`} />
                </motion.button>
              </motion.div>
                      ...
                      <ReactMarkdown
                        ...
                        components={{
                          ...
                          code: ({ inline, children }) =>
                            inline ? (
                              <code className={isBlackoutEnabled ? "bg-gray-800 px-1 rounded" : isIlluminateEnabled ? "bg-gray-200 px-1 rounded" : "bg-gray-800 px-1 rounded"}>
                                {children}
                              </code>
                            ) : (
                              <pre className={isBlackoutEnabled ? "bg-gray-800 p-2 rounded-lg overflow-x-auto" : isIlluminateEnabled ? "bg-gray-200 p-2 rounded-lg overflow-x-auto" : "bg-gray-800 p-2 rounded-lg overflow-x-auto"}>
                                <code>{children}</code>
                              </pre>
                            ),
                        }}
              ...
              >
                <div className="flex gap-2">
                  <input
                    ...
                    className={`flex-1 rounded-xl px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500/50 ${inputBg}`}
                  />
                  <motion.button
                    ...
                    className={`${
                      isIlluminateEnabled ? "bg-blue-600" : "bg-blue-600"
                    } text-white p-2 rounded-xl hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed`}
                  >
