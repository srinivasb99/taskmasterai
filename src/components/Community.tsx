...
export function Community() {
  ...
  // For storing uploader profiles (photoURL, displayName, etc.)
  ...
  // For editing file names (Your Shared Files)
  ...
  const removeFile = async (file: any) => {
    ...
    try {
      ...
      // Delete from Storage (using uniqueFileName)
    ...
    <div className="flex h-screen bg-gray-900">
      ...
      >
        <div className="overflow-y-auto h-full">
          ...
          {/* Each Section is in a scrollable container */}
              ...
              {filteredCommunityUploadedFiles.length === 0 ? (
                ...
                <ul className="space-y-4">
                  {filteredCommunityUploadedFiles.map((file) => {
                    ...
                    return (
                      <li key={file.id} className="p-4 bg-gray-700 rounded-lg">
                        <div className="flex items-center justify-between mb-2">
                          <div className="flex flex-col">
                            <span className="text-indigo-400 hover:underline font-medium">
                          ...
                          <div className="flex items-center gap-2">
                            <div className="w-8 h-8 rounded-full overflow-hidden bg-gray-600">
                              {userProfiles[file.userId]?.photoURL ? (
                                <img
                                  src={userProfiles[file.userId].photoURL}
                                  alt={userProfiles[file.userId].displayName}
                            ...
                            <span className="text-sm text-gray-300">
                              {userProfiles[file.userId]?.displayName || 'Unknown'}
                            </span>
                          </div>
                        </div>
